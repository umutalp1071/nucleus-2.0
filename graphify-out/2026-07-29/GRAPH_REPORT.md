...
5. `MvpScope` - 13 edges
6. `readCollection()` - 13 edges
7. `NUCLEUS 2.0 — CONTEXT TRANSFER` - 13 edges
8. `Plan` - 12 edges
9. `formatUsd()` - 12 edges
10. `recordEvent()` - 12 edges
...
Cohesion: 0.60
Nodes (4): BodySchema, POST(), statusFor(), regenerateArtifact()
